...
@section('content')
    ...
    <table class="table">
        ...
        @foreach($couriers as $courier)
            <tr>
                ...
                <td>{{$courier->phone}}</td>
                <td>
                    <form method="POST" id="delete_product" action="{{route('couriers.destroy',['courier'=>$courier])}}">
                        @csrf
                        {{ method_field('DELETE') }}

                        <a class="btn btn-sm btn-primary" href="{{route('couriers.edit',['courier'=>$courier])}}">
    ...
    <a href="{{route('couriers.create')}}" id="create-product-link">
