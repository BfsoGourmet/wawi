...
@section('content')
        ...
        @foreach($users as $user)
            <tr>
                ...
                <td>
                    ...
                    <form method="POST" id="delete_product" action="{{route('users.destroy',['user'=>$user])}}">
                        @csrf
                        {{ method_field('DELETE') }}

                        <a class="btn btn-sm btn-primary" href="{{route('users.edit',['user'=>$user])}}">
    ...
    <a href="{{route('users.create')}}" id="create-product-link">
