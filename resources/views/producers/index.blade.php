...
@section('content')
    ...
    <table class="table">
        ...
        @foreach($producers as $producer)
            <tr>
                ...
                <td>{{$producer->contact_firstname}}</td>
                <td>{{$producer->contact_lastname}}</td>
                <td>{{$producer->contact_phone}}</td>
                <td>
                    <form method="POST" id="delete_product" action="{{route('producers.destroy',['producer'=>$producer])}}">
                        @csrf
                        {{ method_field('DELETE') }}

                        <a class="btn btn-sm btn-primary" href="{{route('producers.edit',['producer'=>$producer])}}">
    ...
    <a href="{{route('producers.create')}}" id="create-product-link">
